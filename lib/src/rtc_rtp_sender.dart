...
class RTCRtpSender {
  RTCRtpSender(this._id, this._track, this._parameters, this._ownsTrack);

  factory RTCRtpSender.fromMap(Map<dynamic, dynamic> map) {
    return RTCRtpSender(map['senderId'], MediaStreamTrack.fromMap(map['track']),
        RTCRtpParameters.fromMap(map['rtpParameters']), map['ownsTrack']);
  }
